...
export type MoonTrackballVelocity = {
...
export function applyMoonScreenDrag(
...
export function applyMoonAngularVelocity(
  orientation: THREE.Quaternion,
  camera: THREE.Camera,
  velocity: MoonTrackballVelocity,
  delta: number,
) {
...
export function composeMoonOrientation(
